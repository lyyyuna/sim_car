...
#line 49 "crowbar.y"
    {
            SIMCAR_Interpreter *inter = crb_get_current_interpreter();
...
#line 224 "crowbar.y"
    {
            (yyval.expression) = crb_create_boolean_expression(SIMCAR_TRUE);
        }
    break;
...
#line 228 "crowbar.y"
    {
            (yyval.expression) = crb_create_boolean_expression(SIMCAR_FALSE);
        }
    break;
